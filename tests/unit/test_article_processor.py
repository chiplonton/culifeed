...
from culifeed.processing.article_processor import (
    ArticleProcessor,
    ProcessingResult,
    DeduplicationStats,
)
...
class TestArticleProcessor:
    ...
    def test_clean_title(self, article_processor):
        ...
        test_cases = [
            ...
            (
                "Article Title | Site Name Really Long String to Exceed 40 chars",
                "Article Title",
            ),  # Removes | suffix
            ...
            (
                "Advanced Machine Learning Techniques and Neural Networks - TechCrunch",
                "Advanced Machine Learning Techniques and Neural Networks",
            ),  # Removes known site names
            (
    ...
    def test_normalize_url(self, article_processor):
        ...
        test_cases = [
            ...
            (
                "https://example.com/page?utm_medium=email&ref=social",
                "https://example.com/page",
            ),
            (
                "https://example.com/page?important=keep&utm_source=remove",
            ...
            (
                "https://example.com/page?utm_campaign=test#section",
                "https://example.com/page#section",
            ),
        ]
    ...
    def test_find_duplicates_in_batch_no_duplicates(
        self, article_processor, sample_articles
    ):
    ...
    def test_find_duplicates_in_database(
        self, article_processor, sample_articles, test_database
    ):
        ...
        with article_processor.db.get_connection() as conn:
            ...
            """,
                (
                    ...
                    sample_articles[
                        0
                    ].content_hash,  # Same hash as first sample article
    ...
    def test_process_articles_success(self, article_processor, sample_articles):
        ...
        unique_articles, stats = article_processor.process_articles(
            sample_articles, check_database=False
        )
    ...
    def test_process_articles_with_duplicates(self, article_processor):
        ...
        articles_with_duplicates = [
            Article(
                ...
                url="https://test.com/1",
                content="content",
                source_feed="https://test.com/feed",
            ),
            Article(
        ...
        unique_articles, stats = article_processor.process_articles(
            articles_with_duplicates, check_database=False
        )
    ...
    def test_process_articles_error_handling(self, article_processor):
        ...
        unique_articles, stats = article_processor.process_articles(
            invalid_articles, check_database=False
        )
    ...
    def test_get_processing_summary(self, article_processor, sample_articles):
        ...
        articles_with_duplicate = [
            ...
            Article(
                ...
                content="different content",
                source_feed=sample_articles[0].source_feed,
            ),  # Duplicate of first
        ]
    ...
    def test_url_validation_and_cleaning(self, article_processor):
        ...
        for url, should_be_valid in test_urls:
            if should_be_valid:
                ...
                normalized = article_processor.normalize_content(article)
                assert str(normalized.url) == url or str(normalized.url).startswith(
                    "http"
                )
            else:
