...
from culifeed.database.models import Channel, Article, Topic, Feed, ProcessingResult, ChatType
from culifeed.config.settings import CuliFeedSettings, load_settings, AIProvider
from culifeed.utils.logging import setup_logger, get_logger_for_component, PerformanceLogger
from culifeed.utils.exceptions import (
    CuliFeedError, ConfigurationError, DatabaseError, ValidationError, 
    ErrorCode, handle_exception, is_retryable_error
)
...
class TestConfiguration:
    ...
    def test_invalid_configuration(self):
        ...
        with pytest.raises(Exception):  # Should raise validation error
            CuliFeedSettings(
                telegram={'bot_token': 'invalid-token'}
            )
