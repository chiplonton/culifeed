...
class ConfigurationError(CuliFeedError):
    ...
    def __init__(self, message: str, config_key: Optional[str] = None, **kwargs):
        ...
        super().__init__(
            ...
            **{k: v for k, v in kwargs.items() if k not in ['context', 'error_code', 'user_message']}
        )
...
class DatabaseError(CuliFeedError):
    ...
    def __init__(self, message: str, query: Optional[str] = None, **kwargs):
        ...
        super().__init__(
            ...
            **{k: v for k, v in kwargs.items() if k not in ['context', 'error_code', 'user_message', 'recoverable']}
        )
...
class FeedError(CuliFeedError):
    ...
    def __init__(self, message: str, feed_url: Optional[str] = None, **kwargs):
        ...
        super().__init__(
            ...
            context=context,
            user_message=kwargs.get('user_message', f"Feed processing failed: {message}"),
            recoverable=kwargs.get('recoverable', True),
            **{k: v for k, v in kwargs.items() if k not in ['context', 'error_code', 'user_message', 'recoverable']}
        )
    ...
    def __init__(
        ...
        **kwargs
        ...
        super().__init__(
            ...
            context=context,
            user_message=kwargs.get('user_message', "AI processing temporarily unavailable"),
            recoverable=kwargs.get('recoverable', True),
            **{k: v for k, v in kwargs.items() if k not in ['context', 'error_code', 'user_message', 'recoverable']}
        )
...
class ValidationError(CuliFeedError):
    ...
    def __init__(self, message: str, field_name: Optional[str] = None, **kwargs):
        ...
        super().__init__(
            ...
            context=context,
            user_message=kwargs.get('user_message', f"Invalid {field_name or 'input'}: {message}"),
...
class ContentValidationError(ProcessingError):
    ...
    def __init__(self, message: str, content_type: Optional[str] = None, **kwargs):
        ...
        super().__init__(
            ...
            error_code=kwargs.get('error_code', ErrorCode.CONTENT_INVALID),
            context=context,
            user_message=kwargs.get('user_message', f"Content validation failed: {message}"),
            **{k: v for k, v in kwargs.items() if k not in ['context', 'error_code', 'user_message']}
        )
