...
class OpenAIProvider(AIProvider):
    ...
    async def test_connection(self) -> bool:
        ...
        try:
            ...
            if success:
                ...
                self.logger.warning("OpenAI connection test failed - unexpected response")
    ...
    def set_model(self, model_name: str) -> None:
        ...
        if model_name in self.get_available_models():
            ...
            self.logger.warning(f"Unknown OpenAI model: {model_name}, keeping current: {self.model_name}")
